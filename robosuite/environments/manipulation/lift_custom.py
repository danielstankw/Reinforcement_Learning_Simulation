...
from robosuite.models.objects import BoxObject, CylinderObject, PlateWith5mmHoleObject, PlateWithHoleObject
...
class Lift(SingleArmEnv):
    ...
    def __init__(
        ...
        # TODO: peg_pos is: peg_height+table_offset

        assert robots == 'UR5e', 'Robot must be UR5e!'
        assert "JOINT_TORQUE" in controller_configs['type'], "Controller must be JOINT_TORQUE"
    ...
    def _load_model(self):
        ...
        self.peg = CylinderObject(name='cylinder',
                                  size=[self.peg_radius, self.peg_height],
                                  density=1,
                                  duplicate_collision_geoms=True,
                                  rgba=[1, 1, 0, 1], joints=None)
        ...
        #         y_range=[0, 0],
        #         rotation=None,
        #         ensure_object_boundary_in_range=False,  # constraints the object within sampling box
        #         ensure_valid_placement=True,    # ensures no collision with any other placed object
        #         reference_pos=self.table_offset,
        #         z_offset=self.peg_z_offset,
        #     )
    ...
    def _check_success(self):
        ...
        """
        cube_height = self.sim.data.body_xpos[self.peg_body_id][2]
