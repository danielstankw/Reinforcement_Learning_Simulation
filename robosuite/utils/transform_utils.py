...
def Rotation_Matrix_To_Vector(intial_mat, final_mat):
    ...
    """
    R01 = intial_mat  # rotation from 0 to 1 in (0) world frame
    R10 = R01.T
    R02 = final_mat  # rotation from 0 to 1 in (0) world frame
    R12 = np.dot(R10, R02)  # rotation from 1 to 2 in (1) current frame
