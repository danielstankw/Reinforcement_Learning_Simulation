...
def controller_factory(name, params):
    ...
    if name == "IMPEDANCE_WITH_SPIRAL":
        return ImpedanceWithSpiral(interpolator=interpolator, **params)

    if name == "IMPEDANCE_WITH_SPIRAL_AND_ML":
        return ImpedanceWithSpiralAndML(interpolator=interpolator, **params)

    if name == "IMPEDANCE_SPIRAL_LABEL_COLLECTION":
        return ImpedanceSpiralMeasurements(interpolator=interpolator, **params)
