...
class PlateWithHoleObject(MujocoXMLObject):
    """
    plate with a 5 cm hole (used in PegInHole)
    """
...
class PlateWithHoleSmallObject(MujocoXMLObject):
    """
    plate with a 4 mm hole in the center (used in PegInHole)
    """

    def __init__(self, name):
        super().__init__(xml_path_completion("objects/plate-with-hole-4-mm.xml"),
                         name=name, joints=None, obj_type="all", duplicate_collision_geoms=True)

class PlateWithHole10mmShir(MujocoXMLObject):
    """
    plate with a 10 mm hole in the center (used in PegInHole)
    """

    def __init__(self, name):
        super().__init__(xml_path_completion("objects/shir_hole_10mm.xml"),
                         name=name, joints=None, obj_type="all", duplicate_collision_geoms=True)

class PlateWithHoleMediumObject(MujocoXMLObject):
    """
    plate with 25 mm hole in the center (used in PegInHole)
    """

    def __init__(self, name):
        super().__init__(xml_path_completion("objects/plate-with-hole-25-mm.xml"),
                         name=name, joints=None, obj_type="all", duplicate_collision_geoms=True)

class Wire(MujocoXMLObject):
    """
    plate with 25 mm hole in the center (used in PegInHole)
    """

    def __init__(self, name):
        super().__init__(xml_path_completion("objects/wire.xml"),
                         name=name, joints=None, obj_type="all", duplicate_collision_geoms=True)
